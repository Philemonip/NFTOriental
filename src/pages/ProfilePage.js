  ...
  return (
    <>
      ...
      <div>
        ...
        <div>
          <button onClick={() => setProfileContent("Collectibles")}>
            Collectibles
          </button>
          <button onClick={() => setProfileContent("Created")}>
            Created NFT
          </button>
          <button onClick={() => setProfileContent("Transactions")}>
            Transactions
          </button>
          <button onClick={() => setProfileContent("Settings")}>
            Settings
          </button>
        </div>
