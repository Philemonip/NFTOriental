...
const SellerItems = [
  {
    ...
    body:
      "OrientalNFT is powered by Metamask on Ethereum Rinkeby Network. Connect to OrientalNFT with your Metamask account to access all the functions we offer including receiving Cinco Chicos Coin (CCH) at our De-Fi bank and making NFT transactions.",
  },
  {
    logo: <FaEthereum />,
    title: "Import CCH to Metamask",
    body:
      "In your Metamask extention, scroll to bottom in the mainpage, press 'Add Token', then paste '0xbe63D70116B4efd27b7Ed42F0851BdF6d6ae3DbB' in the Token Contract Address, press 'Next' afterwards to add our ERC20 token to your Metamask wallet.",
  },
  {
  ...
  },
  {
    ...
    body:
      "Choose the price you wish to sell for your NFTs, which is traded in Cinco Chicos Coin (CCH). Other users on OrientalNFT will be able to purchase your NFTs once your NFT is listed on sale.",
  },
];
...
const BuyerItems = [
  ...
  },
  {
    ...
    body:
      "Browse and purchase your favourite NFTs from one of our 6 unique collections. After your purchase, you can list them on sale again to trade with other users on OrientalNFT.",
  },
];
